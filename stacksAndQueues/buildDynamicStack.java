...
// 4. You are required to change the body of push function to accept the element even when the data array is
// completely full. In that case, you are required to reallocate the data array (to twice it's size).
// You should not print "Stack overflow" ever.
    ...
    public static class CustomStack {
        ...
        void push(int val) {
          if (tos == data.length - 1) {
            ...
            data = newData; // data now points to the newData array
            tos++;
            data[tos] = val;
          } else {
            tos++;
