...
public class distanceBWTwoNodes {
    ...
    private static class Node {
      ...
      public static int distanceBetweenNodes(Node node, int d1, int d2){
        ...
        // i and j are at first unequal elements in their arraylists
        
        // to put them on the least common ancestor i.e the common element
        i++;
        j++;
        
        // lca is the diverging point 
        // distance => index of lca in p1 &  index of lca in p2
        return i+j;
      }
