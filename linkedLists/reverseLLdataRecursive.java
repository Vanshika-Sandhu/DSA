...
// 2. You are required to complete the body of re and reverseDR functions. The function are expected to print in reverse the linked list without actually reversing it. 
    ...
    public static class Node {
      ...
      public static class LinkedList {
        ...
        private void reverseDRHelper(Node right, int floor){
          ...
          reverseDRHelper(right.next, floor++);
        //   swapping values
          while(floor >= size/2){
              int temp = right.data;
