...
public class addTwoLL {
    ...
    public static class Node {
      ...
      public static class LinkedList {
        ...
        private static int addTwoListsHelper(Node one, int pv1, Node two, int pv2, LinkedList result){
            ...
            int data = 0;
            if(pv1>pv2){
                int oc = addTwoListsHelper(one.next, pv1-1, two, pv2, result);
                data = one.data + oc;
            }else if(pv1<pv2){
                int oc = addTwoListsHelper(one, pv1, two.next, pv2-1, result);
                data = two.data + oc;
            }else{
                int oc = addTwoListsHelper(one.next, pv1-1, two.next, pv2-1, result);
        ...
        public static LinkedList addTwoLists(LinkedList one, LinkedList two) {
          ...
          int c = addTwoListsHelper(one.head, one.size, two.head, two.size, result);
          if(c>0){
              result.addFirst(c);
          }
