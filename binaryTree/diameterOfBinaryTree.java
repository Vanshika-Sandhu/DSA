...
public class diameterOfBinaryTree{
    ...
    //   approach 2 => efficien | o(n) | no use of height function
      public static DiaPair diameter2(Node node){
          if(node == null){
              DiaPair bcp = new DiaPair();
              bcp.ht = -1;
              bcp.dia = 0;
              return bcp;
          }
          ...
          mp.dia = Math.max(lp.ht + rp.ht + 2, Math.max(lp.ht, rp.ht));
          
          return mp;
      }
      
    //   Approach 1 => inefficien | o(n*n)
    // recursive function diameter again uses recursive function height
      public static int diameter1(Node node) {
        ...
        int fact = height(node.left) + height(node.right) + 2;
